...
class SubReporter:
    ...
    def measure_iter_time(self, iterables, name: str, prime_iter_sample_ratio: int):
        iterators = []
        ...
        while True:
            try:
                import random
                noisy_label_flag = (random.random() < prime_iter_sample_ratio)
                if noisy_label_flag:
