...
def collect_stats(
    ...
    train_pseudo_iter: DataLoader and Iterable[Tuple[List[str], Dict[str, torch.Tensor]]],
    ...
    npy_scp_writers = {}
    for itr, mode in zip([train_iter, train_pseudo_iter, valid_iter], ["train", "train_pseudo", "valid"]):
